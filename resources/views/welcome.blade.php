...
@section('description', 'Halaman sambutan bertema Harry Potter dengan opsi daftar Triwizard House Cup atau login. Versi sederhana tanpa efek bersinar, dengan pertanyaan kepribadian 1–5 yang dapat diklik.')
  ...
  <header class="relative z-10">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4 sm:py-6 flex items-center justify-between">
      ...
      <div class="hidden sm:flex items-center gap-3">
        <a href="{{ route('login') }}" class="inline-flex items-center gap-2 rounded-lg border border-amber-400/30 bg-amber-50/5 px-4 py-2 text-amber-200 hover:bg-amber-400/10 transition">
