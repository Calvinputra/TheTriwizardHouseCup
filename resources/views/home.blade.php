...
@section('description', 'Beranda peserta dengan tiket bergaya Harry Potter, video reveal House, dan tombol gabung WhatsApp Group per House.')
...
@php
  ...
  $houseData = [
    'gryffindor' => [
      'title'       => 'Gryffindor',
      'desc'        => 'Rumah para pemberani, ksatria, dan berjiwa kepemimpinan. Mereka menjunjung tinggi keberanian, tekad, dan kebajikan.',
      'leader'      => 'Kepala House: Prof. Felicia',
      'wa'          => "https://chat.whatsapp.com/I14RUYsWkjqJPona0MXojn",
    ],
    'slytherin' => [
      'title'       => 'Slytherin',
      'desc'        => 'Ambisi, kecerdikan, dan tekad kuat. Para murid Slytherin dikenal licin namun cerdas mencapai tujuan.',
    ...
    'hufflepuff' => [
      'title'       => 'Hufflepuff',
      'desc'        => 'Kerja keras, kesetiaan, dan kejujuran. Para Hufflepuff dikenal rendah hati dan dapat diandalkan.',
  ...
  $candidate = $isYoutube ? $localFile : (pathinfo((string)$revealInput, PATHINFO_EXTENSION) === 'mp4' ? $revealInput : $localFile);
        ...
        @if($hasRealHouse && !empty($revealVideo))
          <div class="lg:col-span-2 rounded-2xl border border-amber-400/30 bg-[#0f0c19]/80 p-4">
            ...
            <div class="mt-3 flex flex-wrap gap-2 justify-center">
              <button
                @click="revealed = true; showHouseDetail = true"
